...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const checkDesktop = () => {
      ...
      console.log('Profile: Проверка isDesktop:', desktop);
    };
    checkDesktop();
  ...
  useEffect(() => {
    if (!isInitialized) {
      console.log('Profile: Ожидание инициализации');
      return;
    }
    if (!userId) {
    ...
    console.log('Profile: Загрузка данных профиля и постов для userId:', userId);
    Promise.all([
      ...
      .then(([profileData, postsData]) => {
        console.log('Profile: Данные профиля загружены:', profileData);
        console.log('Profile: Посты загружены:', postsData);
        setProfile({
      ...
      .catch((err) => {
        console.error('Profile: Ошибка загрузки данных:', err.message);
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    setError(null);
    console.log('Profile: Попытка обновления профиля:', profile);
    ...
    try {
      ...
      console.log('Profile: Ответ /api/profile:', res.status, res.statusText);
  ...
  const handlePostSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    setError(null);
    console.log('Profile: Попытка создания/обновления поста:', { postContent, editingPostId });
    ...
    try {
      ...
      console.log('Profile: Ответ /api/posts:', res.status, res.statusText);

      if (!res.ok) {
        const errorData = await res.json();
        console.log('Profile: Ошибка сервера:', errorData);
      ...
      console.error('Profile: Ошибка с постом:', err.message);
      setError(err.message);
    } finally {
      setSubmitting(false);
    }
  ...
  const handleDeletePost = async (postId: string) => {
    try {
      ...
      console.error('Profile: Ошибка удаления поста:', err.message);
      setError(err.message);
    }
  };
